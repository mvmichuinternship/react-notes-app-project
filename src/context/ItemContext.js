  ...
  switch (action.type) {
    ...
    case actions.REMOVE_ITEM:
      ...
      case actions.GET_BY_ID:
        ...
        case actions.GET_USER_BY_ID:
          var getUserById = state.users.find(
    ...
    case actions.EDIT_ITEM:
      ...
      return {
        ...
        items : state.items.map((item)=> item.title==newEdit.title? newEdit : item)
      };
    default:
        return state
  }
...
export const ItemManagerProvider = ({ children }) => {
  ...
  const value = {
    ...
    singleUser:state.singleUser,
    users:state.users,
    addItem: ({item_title, item_desc, item_image, item_progress, item_completed, item_deadline, item_reminder,uid}) => {
      dispatch({ type: actions.ADD_ITEM, payload:{
        item_title, item_desc, item_image, item_progress, item_completed, item_deadline, item_reminder,uid
    ...
    editItem:({item_title, item_desc, item_image, item_progress, item_completed, item_deadline, item_reminder,uid})=>{
        dispatch({type:actions.EDIT_ITEM, payload:{item_title, item_desc, item_image, item_progress, item_completed, item_deadline, item_reminder,uid}})
    }
  };
